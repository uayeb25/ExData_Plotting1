...
mydata.sample$Voltage <- as.numeric(as.character(mydata.sample$Voltage))
mydata.sample$Global_reactive_power <- as.numeric(as.character(mydata.sample$Global_reactive_power))
...
plot(mydata.sample$Time,mydata.sample$Global_active_power, type = "l",ylab = "Globa Active Power",xlab = "")

plot(mydata.sample$Time,mydata.sample$Voltage, type = "l",ylab = "Voltage",xlab = "datetime")
...
plot(mydata.sample$Time,mydata.sample$Global_reactive_power, type = "l",ylab = "Global_reactive_power",xlab = "datetime")
